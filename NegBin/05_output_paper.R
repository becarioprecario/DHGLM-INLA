############################### Summary of results 
############################### Negative binomial (simulated data)
# True values: beta_0 = 1, beta_1 = 0.25, gamma_0 = 0, gamma_1 = 5
...
coda_nb <- to_coda_samples(js[c("beta", "gamma")])
...
# Show estimated parameters (Mean, SD and 95% Credible Interval)
summ.mcmc <- cbind(summary(coda_nb)$statistics[,c(1,2)],summary(coda_nb)$quantiles[,c(1,5)])
summ.mcmc
